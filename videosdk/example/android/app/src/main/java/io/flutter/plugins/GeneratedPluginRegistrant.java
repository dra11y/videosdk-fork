...
public final class GeneratedPluginRegistrant {
  ...
  public static void registerWith(@NonNull FlutterEngine flutterEngine) {
    ...
    try {
      flutterEngine.getPlugins().add(new videosdk.live.videosdk_media_effects.VideosdkMediaEffectsPlugin());
    } catch (Exception e) {
      Log.e(TAG, "Error registering plugin videosdk_media_effects, videosdk.live.videosdk_media_effects.VideosdkMediaEffectsPlugin", e);
    }
    try {
