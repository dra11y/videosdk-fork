...
//  source: videosdk_otel/proto/common/v1/common.proto
//
// @dart = 2.12
...
const AnyValue$json = const {
  ...
  '2': const [
    ...
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.videosdk_otel.proto.common.v1.ArrayValue',
      '9': 0,
      '10': 'arrayValue'
    },
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.videosdk_otel.proto.common.v1.KeyValueList',
      '9': 0,
      '10': 'kvlistValue'
    },
    const {
...
final $typed_data.Uint8List anyValueDescriptor = $convert.base64Decode(
    '');
...
const ArrayValue$json = const {
  ...
  '2': const [
    const {
      ...
      '4': 3,
      '5': 11,
      '6': '.videosdk_otel.proto.common.v1.AnyValue',
      '10': 'values'
    },
  ],
};
...
final $typed_data.Uint8List arrayValueDescriptor = $convert.base64Decode(
    'CgpBcnJheVZhbHVlEj8KBnZhbHVlcxgBIAMoCzInLm9wZW50ZWxlbWV0cnkucHJvdG8uY29tbW9uLnYxLkFueVZhbHVlUgZ2YWx1ZXM=');
...
final $typed_data.Uint8List keyValueListDescriptor = $convert.base64Decode(
    'CgxLZXlWYWx1ZUxpc3QSPwoGdmFsdWVzGAEgAygLMicub3BlbnRlbGVtZXRyeS5wcm90by5jb21tb24udjEuS2V5VmFsdWVSBnZhbHVlcw==');
...
final $typed_data.Uint8List keyValueDescriptor = $convert.base64Decode(
    'CghLZXlWYWx1ZRIQCgNrZXkYASABKAlSA2tleRI9CgV2YWx1ZRgCIAEoCzInLm9wZW50ZWxlbWV0cnkucHJvdG8uY29tbW9uLnYxLkFueVZhbHVlUgV2YWx1ZQ==');
...
final $typed_data.Uint8List stringKeyValueDescriptor = $convert.base64Decode(
    'Cg5TdHJpbmdLZXlWYWx1ZRIQCgNrZXkYASABKAlSA2tleRIUCgV2YWx1ZRgCIAEoCVIFdmFsdWU6AhgB');
...
final $typed_data.Uint8List instrumentationLibraryDescriptor =
    $convert.base64Decode(
        'ChZJbnN0cnVtZW50YXRpb25MaWJyYXJ5EhIKBG5hbWUYASABKAlSBG5hbWUSGAoHdmVyc2lvbhgCIAEoCVIHdmVyc2lvbg==');
