...
class AnyValue extends $pb.GeneratedMessage {
  ...
  AnyValue copyWith(void Function(AnyValue) updates) =>
      super.copyWith((message) => updates(message as AnyValue))
          as AnyValue; // ignore: deprecated_member_use
...
class KeyValueList extends $pb.GeneratedMessage {
  ...
  KeyValueList copyWith(void Function(KeyValueList) updates) =>
      super.copyWith((message) => updates(message as KeyValueList))
          as KeyValueList; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class InstrumentationLibrary extends $pb.GeneratedMessage {
  ...
  factory InstrumentationLibrary.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory InstrumentationLibrary.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
      'Will be removed in next major version')
  InstrumentationLibrary clone() =>
      InstrumentationLibrary()..mergeFromMessage(this);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  InstrumentationLibrary copyWith(
          void Function(InstrumentationLibrary) updates) =>
      super.copyWith((message) => updates(message as InstrumentationLibrary))
          as InstrumentationLibrary; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static InstrumentationLibrary create() => InstrumentationLibrary._();
  InstrumentationLibrary createEmptyInstance() => create();
  static $pb.PbList<InstrumentationLibrary> createRepeated() =>
      $pb.PbList<InstrumentationLibrary>();
  @$core.pragma('dart2js:noInline')
  static InstrumentationLibrary getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<InstrumentationLibrary>(create);
