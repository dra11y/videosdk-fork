...
class ExportTraceServiceRequest extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName(
          const $core.bool.fromEnvironment('protobuf.omit_message_names')
              ? ''
              : 'videosdk_otel.proto.collector.trace.v1'),
    ...
    ..pc<$2.ResourceSpans>(
        ...
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ...
            : 'resourceSpans',
        $pb.PbFieldType.PM,
        subBuilder: $2.ResourceSpans.create)
  ...
  ExportTraceServiceRequest copyWith(
      ...
      super.copyWith((message) => updates(message as ExportTraceServiceRequest))
          as ExportTraceServiceRequest; // ignore: deprecated_member_use
...
class ExportTraceServiceResponse extends $pb.GeneratedMessage {
  ...
  ExportTraceServiceResponse copyWith(
      ...
      super.copyWith(
          ...
          as ExportTraceServiceResponse; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class TraceServiceApi {
  ...
  $async.Future<ExportTraceServiceResponse> export(
    ...
    final emptyResponse = ExportTraceServiceResponse();
    return _client.invoke<ExportTraceServiceResponse>(
        ctx, 'TraceService', 'Export', request, emptyResponse);
  }
}
