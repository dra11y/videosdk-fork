...
class ResourceSpans extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..pc<InstrumentationLibrarySpans>(
        2,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'instrumentationLibrarySpans',
        $pb.PbFieldType.PM,
        subBuilder: InstrumentationLibrarySpans.create)
    ..aOS(
        3,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
  ...
  ResourceSpans copyWith(void Function(ResourceSpans) updates) =>
      super.copyWith((message) => updates(message as ResourceSpans))
          as ResourceSpans; // ignore: deprecated_member_use
  ...
  @$pb.TagNumber(2)
  $core.List<InstrumentationLibrarySpans> get instrumentationLibrarySpans =>
      $_getList(1);
...
class InstrumentationLibrarySpans extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName(
          const $core.bool.fromEnvironment('protobuf.omit_message_names')
              ...
              : 'videosdk_otel.proto.trace.v1'),
      createEmptyInstance: create)
    ..aOM<$0.InstrumentationLibrary>(
        1,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'instrumentationLibrary',
        subBuilder: $0.InstrumentationLibrary.create)
    ..pc<Span>(
        2,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
  ...
  factory InstrumentationLibrarySpans.fromBuffer($core.List<$core.int> i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromBuffer(i, r);
  factory InstrumentationLibrarySpans.fromJson($core.String i,
          [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) =>
      create()..mergeFromJson(i, r);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
      'Will be removed in next major version')
  InstrumentationLibrarySpans clone() =>
      InstrumentationLibrarySpans()..mergeFromMessage(this);
  @$core.Deprecated('Using this can add significant overhead to your binary. '
      'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
      'Will be removed in next major version')
  InstrumentationLibrarySpans copyWith(
          void Function(InstrumentationLibrarySpans) updates) =>
      super.copyWith(
              (message) => updates(message as InstrumentationLibrarySpans))
          as InstrumentationLibrarySpans; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
  static InstrumentationLibrarySpans create() =>
      InstrumentationLibrarySpans._();
  InstrumentationLibrarySpans createEmptyInstance() => create();
  static $pb.PbList<InstrumentationLibrarySpans> createRepeated() =>
      $pb.PbList<InstrumentationLibrarySpans>();
  @$core.pragma('dart2js:noInline')
  static InstrumentationLibrarySpans getDefault() => _defaultInstance ??=
      $pb.GeneratedMessage.$_defaultFor<InstrumentationLibrarySpans>(create);
  static InstrumentationLibrarySpans? _defaultInstance;

  @$pb.TagNumber(1)
  $0.InstrumentationLibrary get instrumentationLibrary => $_getN(0);
  @$pb.TagNumber(1)
  set instrumentationLibrary($0.InstrumentationLibrary v) {
    setField(1, v);
  }
...
class Span_Event extends $pb.GeneratedMessage {
  ...
  Span_Event copyWith(void Function(Span_Event) updates) =>
      super.copyWith((message) => updates(message as Span_Event))
          as Span_Event; // ignore: deprecated_member_use
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class Status extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
      ...
      package: const $pb.PackageName(
          const $core.bool.fromEnvironment('protobuf.omit_message_names')
              ...
              : 'videosdk_otel.proto.trace.v1'),
      createEmptyInstance: create)
    ..e<Status_DeprecatedStatusCode>(
        1,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
            : 'deprecatedCode',
        $pb.PbFieldType.OE,
        defaultOrMaker: Status_DeprecatedStatusCode.DEPRECATED_STATUS_CODE_OK,
        valueOf: Status_DeprecatedStatusCode.valueOf,
        enumValues: Status_DeprecatedStatusCode.values)
    ..aOS(
        2,
        const $core.bool.fromEnvironment('protobuf.omit_field_names')
            ? ''
  ...
  @$core.Deprecated('This field is deprecated.')
  @$pb.TagNumber(1)
  set deprecatedCode(Status_DeprecatedStatusCode v) {
    setField(1, v);
  }
